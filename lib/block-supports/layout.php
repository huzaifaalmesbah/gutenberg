...
function gutenberg_render_layout_support_flag( $block_content, $block ) {
	...
	if ( ! $block_supports_layout && ! $has_child_layout ) {
	...
	/*
	 * A block may not support layout, but may still have attributes which
	 * specify that certain class names be applied to its outermost tag.
	 *
	 * In these cases add those class names and then return early; there's
	 * nothing further within the block to process.
	 */
